...
function fakeMessage() {
    $('<div class="message new"><figure class="avatar"><img src="fireprofile.png" /></figure>안녕하세요? 전 러키둥이에요. 이름이 뭔가요?</div>').appendTo($('.mCSB_container')).addClass('new');
    setDate();H
    updateScrollbar();
}
...
async function sendMessage() {
    ...
    try {
        const response = await fetch('https://tsicb6ppxyhxmxiy4lczhre25q0iihbr.lambda-url.ap-northeast-2.on.aws//fortuneTell', {
            method: 'POST',
            headers: {
